...
import { ChevronLeft, Save, StepBack } from 'lucide-react';
        ...
        >
            ...
            <div className="flex flex-col gap-3">
                ...
                <form onSubmit={submit}>
                    <h1 className='text-center my-3'>Dados do utilizador: <span className='font-bold'>{user.name}</span></h1>
                    ...
                    <div className="grid w-full grid-cols-1 md:grid-cols-2 gap-3 mt-3">
                        <div>
                            <Label className='dark:text-white' htmlFor="role">Papeis de utilizador</Label>
                            <MultiSelect
                                options={db_roles}
                                onValueChange={(value) => setData('roles', value)}
                                defaultValue={data.roles}
                                placeholder="Selecione os pais do utilizador"
                                variant="inverted"
                                animation={2}
                                maxCount={3}
                            />
                    ...
                    <div className="flex items-center justify-end mt-4">
                        <Link href='/users'>
                            <Button className="ms-4 flex gap-1 dark:text-white" variant="outline" type='button'>
                                <StepBack />
                                Cancelar
                            </Button>
                        </Link>
